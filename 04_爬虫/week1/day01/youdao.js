this.seajs = {_seajs: this.seajs}, seajs.version = "1.3.1", seajs._util = {}, seajs._config = {
    ...
    function o(e, i) {
        ...
        g[o] ? i() : m[o] ? v[o].push(i) : (m[o] = !0, v[o] = [i], r._fetch(o, function () {
            g[o] = !0;
            var n = f[e];
            n.status === h.FETCHING && (n.status = h.FETCHED), y && (r._save(e, y), y = null), b && n.status === h.FETCHED && (f[e] = b, b.realUri = e), b = null, m[o] && delete m[o], (n = v[o]) && (delete v[o], t.forEach(n, function (e) {
                e()
            }))
        }, n.charset))
    }
    ...
    function l(e) {
        ...
        return t.filter(e.dependencies, function (e) {
            return x = [n], (e = c(f[e])) && (x.push(n), t.log("Found circular dependencies:", x.join(" --\x3e "), void 0)), !e
        })
    }
    ...
    !function (e, t) {
        ...
        var n, r, i, o = e, a = o.document, s = o.navigator, l = o.setTimeout, c = o.clearTimeout, u = o.setInterval,
            ...
            g = o.Number.parseInt || o.parseInt, v = o.Number.parseFloat || o.parseFloat, y = o.Number.isNaN || o.isNaN,
            b = o.Date.now, x = o.Object.keys, w = o.Object.prototype.hasOwnProperty, T = o.Array.prototype.slice,
            _ = function () {
                var e = function (e) {
                    return e
                };
                ...
                var t, n, r, i;
                if ("object" != typeof e || null == e || "number" == typeof e.nodeType) t = e; else if ("number" == typeof e.length) for (t = [], n = 0, r = e.length; n < r; n++) w.call(e, n) && (t[n] = k(e[n])); else {
                    t = {};
            ...
            H = "html" === a.documentElement.nodeName, q = {
                bridge: null,
                version: "0.0.0",
                pluginType: "unknown",
                sandboxed: null,
            ...
            Y = new RegExp("^flash-(" + V.map(function (e) {
                ...
                return Ye(), {
                    browser: S(E(s, ["userAgent", "platform", "appName", "appVersion"]), {isSupported: Q()}),
                    flash: j(q, ["bridge"]),
                ...
                if ((e = me(e)) && !Te(e)) return "ready" === e.type && !0 === q.overdue ? Ke.emit({
                    type: "error",
                    name: "flash-overdue"
                }) : (t = S({}, e), xe.call(this, t), "copy" === e.type && (n = (r = De(z)).data, B = r.formatMap), n)
            }, oe = function () {
                ...
                for (var r in n) "string" == typeof r && r && w.call(n, r) && "string" == typeof n[r] && n[r] && (z[r] = Ve(n[r]))
            }, ce = function (e) {
                void 0 === e ? (N(z), B = null) : "string" == typeof e && w.call(z, e) && delete z[e]
            }, ue = function (e) {
                return void 0 === e ? k(z) : "string" == typeof e && w.call(z, e) ? z[e] : void 0
            }, fe = function (e) {
                if (e && 1 === e.nodeType) {
                    r && (qe(r, K.activeClass), r !== e && qe(r, K.hoverClass)), r = e, He(e, K.hoverClass);
                ...
                if ("string" == typeof e && e ? (t = e, e = {}) : "object" == typeof e && e && "string" == typeof e.type && e.type && (t = e.type), t) {
                    t = t.toLowerCase(), !e.target && (/^(copy|aftercopy|_click)$/.test(t) || "error" === t && "clipboard-error" === e.name) && (e.target = i), S(e, {
                        type: t,
                    ...
                    }), Z.test(e.name) && S(e, {version: q.version}), "flash-insecure" === e.name && S(e, {
                ...
                if (e && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type)) {
                    var t = e.target, n = "_mouseover" === e.type && e.relatedTarget ? e.relatedTarget : void 0,
                        r = "_mouseout" === e.type && e.relatedTarget ? e.relatedTarget : void 0, i = ze(t),
                ...
                if ("object" == typeof e && e && e.type) {
                    var t = ye(e), n = P["*"] || [], r = P[e.type] || [], i = n.concat(r);
                    if (i && i.length) {
                        var a, s, l, c, u, f = this;
                        for (a = 0, s = i.length; a < s; a++) c = f, "string" == typeof(l = i[a]) && "function" == typeof o[l] && (l = o[l]), "object" == typeof l && l && "function" == typeof l.handleEvent && (c = l, l = l.handleEvent), "function" == typeof l && (u = S({}, e), be(l, c, [u], t))
                    }
                    return this
                }
            }, we = function (e) {
                var t = null;
                return (!1 === I || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1), t
            }, Te = function (e) {
                var t = e.target || r || null, o = "swf" === e._source;
                switch (delete e._source, e.type) {
                    case"error":
                        var a = "flash-sandboxed" === e.name || we(e);
                        "boolean" == typeof a && (q.sandboxed = a), "browser-unsupported" === e.name ? S(q, {
                            disabled: !1,
                            outdated: !1,
                            unavailable: !1,
                            degraded: !1,
                    ...
                    case"copy":
                        ...
                        !z["text/html"] && !z["text/plain"] && u && (c = u.value || u.outerHTML || u.innerHTML) && (l = u.value || u.textContent || u.innerText) ? (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", l), c !== l && e.clipboardData.setData("text/html", c)) : !z["text/plain"] && e.target && (l = e.target.getAttribute("data-clipboard-text")) && (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", l));
                        break;
                    case"aftercopy":
                        _e(e), Ke.clearData(), t && t !== Ie() && t.focus && t.focus();
                        break;
                    case"_mouseover":
                        Ke.focus(t), !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !A(e.relatedTarget, t) && Ce(S({}, e, {
                            type: "mouseenter",
                            bubbles: !1,
                            cancelable: !1
                        })), Ce(S({}, e, {type: "mouseover"})));
                        break;
                    case"_mouseout":
                        Ke.blur(), !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !A(e.relatedTarget, t) && Ce(S({}, e, {
                            type: "mouseleave",
                            bubbles: !1,
                            cancelable: !1
                        })), Ce(S({}, e, {type: "mouseout"})));
                        break;
                    case"_mousedown":
                        He(t, K.activeClass), !0 === K.bubbleEvents && o && Ce(S({}, e, {type: e.type.slice(1)}));
                        break;
                    case"_mouseup":
                        qe(t, K.activeClass), !0 === K.bubbleEvents && o && Ce(S({}, e, {type: e.type.slice(1)}));
                        break;
                    case"_click":
                        i = null, !0 === K.bubbleEvents && o && Ce(S({}, e, {type: e.type.slice(1)}));
                        break;
                    case"_mousemove":
                        !0 === K.bubbleEvents && o && Ce(S({}, e, {type: e.type.slice(1)}))
                }
                if (/^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type)) return !0
            }, _e = function (e) {
                if (e.errors && e.errors.length > 0) {
                    var t = k(e);
                    S(t, {type: "error", name: "clipboard-error"}), delete t.success, l(function () {
                        Ke.emit(t)
                    }, 0)
                }
            }, Ce = function (e) {
                ...
                if ("number" == typeof e && e >= 0) {
                    ...
                    $ = u(function () {
                        ...
                        Be(e) && (Ue(), q.deactivated = null, Ke.emit({type: "error", name: "swf-not-found"}))
                    }, t)
                }
            }, ke = function () {
                ...
                if (!t) {
                    var r = Re(o.location.host, K), i = "never" === r ? "none" : "all",
                        s = Fe(S({jsVersion: Ke.version}, K)), l = K.swfPath + Le(K.swfPath, K);
                    H && (l = je(l)), n = ke();
                ...
                var t = d(e, null);
                if (!t) return !1;
                var n = v(t.height) > 0, r = v(t.width) > 0, i = v(t.top) >= 0, o = v(t.left) >= 0, a = n && r && i && o,
                    s = a ? null : ze(e);
                ...
                q.disabled = !0 !== a, q.outdated = u && v(u) < v("11.0.0"), q.version = u || "0.0.0", q.pluginType = c ? "pepper" : l ? "activex" : a ? "netscape" : "unknown"
            };
        Ze(h), Ye(!0);
        var Ke = function () {
        ...
        var nt = function (e) {
            ...
            var t, n = this;
            return ft.call(n, e) && ("object" == typeof e && e && "string" == typeof e.type && e.type && (e = S({}, e)), t = S({}, me(e), {client: n}), dt.call(n, t)), n
        }, st = function (e) {
            ...
            if ("object" == typeof e && e && e.type && t) {
                var n = ye(e), r = t && t.handlers["*"] || [], i = t && t.handlers[e.type] || [], a = r.concat(i);
                if (a && a.length) {
                    var s, l, c, u, f, d = this;
                    for (s = 0, l = a.length; s < l; s++) u = d, "string" == typeof(c = a[s]) && "function" == typeof o[c] && (c = o[c]), "object" == typeof c && c && "function" == typeof c.handleEvent && (u = c, c = c.handleEvent), "function" == typeof c && (f = S({}, e), be(c, u, [f], n))
                }
            }
        }, pt = function (e) {
    ...
    function r() {
        ...
        i("#loginWindow .content").append(n), window.loginSuccess = function () {
            a.hide(), s.hide(), window.location.reload(!0)
        }
    }

    var i = e("./jquery-1.7"), o = i("#loginAlert"), a = i("#dialogCover"), s = i("#loginWindow"), l = e("./log");
    t.init = function () {
        if (r(), o.find(".dialog-alert--close").on("click", function () {
            n()
        }), o.find(".cancel, .ok").on("click", function () {
            n()
        }), i(".login-link").on("click", function () {
            l.clog("LOGIN_CLICK", ""), a.show(), s.show()
        }), s.find(".dialog-alert--close").on("click", function () {
            a.hide(), s.hide()
        }), i(".login-out").length > 0) {
            var e = i(".login-out").attr("href");
            e += window.encodeURIComponent(window.location.href), i(".login-out").attr("href", e)
        }
    ...
    t.errorMsg = {
        10: "鎶辨瓑锛屼釜鍒彞瀛愬お闀垮暒锛屾垜璇讳笉鎳�",
        20: "鎶辨瓑锛岃秴杩�2涓囧瓧瀹炲湪澶暱鍟︼紝璁╂垜鍠樺彛姘�",
        30: "鎶辨瓑锛屾垜缁炲敖鑴戞眮浜�",
        40: "鎶辨瓑锛屾垜杩樺湪瀛︿範璇ヨ绉嶄腑",
        50: "鎶辨瓑锛岃涓嶈棰戠箒璇锋眰鏈嶅姟",
        transRequestError: "缈昏瘧鍑洪敊锛岃妫€鏌ョ綉缁滃悗閲嶈瘯"
    }
    ...
    window.copyResult = function () {
        return n.trim(n("#transTarget").html().replace(/<br\s+.*?>/gi, "\n").replace(/<\/p>/gi, "\r\n").replace(/<p.*?>/gi, "").replace(/<span.*?>/gi, "").replace(/<\/span>/gi, "").replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&copy;/g, "漏"))
    };
    var o = function () {
        window.clipboardData && (window.clipboardData.clearData(), window.clipboardData.setData("Text", copyResult()) || alert("鎮ㄧ殑娴忚鍣ㄤ笉鏀寔鐩存帴澶嶅埗鍔熻兘锛岃鎵嬪姩澶嶅埗銆�"))
    };
    t.init = function () {
        function e(e) {
            alert("鎮ㄧ殑娴忚鍣ㄤ笉鏀寔鐩存帴澶嶅埗鍔熻兘锛岃鎵嬪姩澶嶅埗锛涙垨鍦ㄦ祻瑙堝櫒璁剧疆涓紑鍚痜lash鎻掍欢鍔熻兘銆�")
        }
        ...
        if (document.oncopy = function (e) {
            ...
            if (Clipboard.isSupported()) {
                ...
                return t.on("success", function (e) {
                    n("#targetCopy .tips__text--short").text("宸插鍒�"), r.clog("COPY_CLICK"), setTimeout(function () {
                        n("#targetCopy .tips__text--short").text("澶嶅埗")
                    }, 1e3)
                }), void t.on("error", function (e) {
                    r.clog("COPY_CLICK"), alert("鎮ㄧ殑娴忚鍣ㄤ笉鏀寔鐩存帴澶嶅埗鍔熻兘锛岃鎵嬪姩澶嶅埗銆�")
                })
            }
            if (n.browser.msie) n('<a id="copyit" href="javascript:;" title=""></a>').appendTo("#targetCopy").show().click(function () {
                return o(), r.clog("COPY_CLICK"), n("#targetCopy .tips__text--short").text("宸插鍒�"), n(this).text("").blur(), setTimeout(function () {
                    n("#targetCopy .tips__text--short").text("澶嶅埗")
                }, 1e3), !1
            }); else {
                ...
                n("#targetCopy").on("click", e), a.on("ready", function (t) {
                    a.on("copy", function (e) {
                        e.clipboardData.setData("text/plain", copyResult()), n("#targetCopy .tips__text--short").text("宸插鍒�"), r.clog("COPY_CLICK"), setTimeout(function () {
                            n("#targetCopy .tips__text--short").text("澶嶅埗")
                        }, 1e3)
    ...
    function n() {
        var e = p("#language").val().split("2"), t = p("#docUploadFile").val(), n = t.split("."), r = n[n.length - 1],
            i = t.split("\\"), o = i[i.length - 1], a = p("#docUploadFile")[0].files, s = 1e3;
    ...
    function o(e, t) {
        ...
        E = n, p(".doc-name").text(n), p(".doc-size-msg").text(r), e ? (_.find(".doc-type").addClass("doc-type-error"), p(".doc-error-msg").text(i).show(), p(".doc-size-msg").text(r).hide()) : (_.find(".doc-type").removeClass("doc-type-error"), p(".doc-error-msg").text(i).hide(), p(".doc-size-msg").text(r).show()), f(), _.show()
    }
    ...
    function l(e) {
        s({percent: "100%", name: ""}), setTimeout(function () {
            if (0 == e.errorcode && e.key) {
                var t = n(), r = A;
                -1 != location.search.indexOf("type=pdf") && (r = resultUrlPdf), p("#language").val("AUTO"), window.location.href = [r, "?key=" + e.key, "&from=" + t.from, "&to=" + t.to, "&type=" + t.type].join("")
                ...
                percent: "0%",
                name: ""
            }), N ? N = !0 : alert("涓婁紶鎴栬В鏋愬け璐ワ紙閿欒浠ｇ爜:" + e.errorcode + "锛�"))
        }, 500)
    }
    ...
    function u() {
        k && (k.ajaxStop(), k = null), S.hide(), s({percent: "0%", name: ""})
    }
    ...
    var h = e("../langSelect"), m = e("./utils"), g = e("./log"), v = p("#docUploadCon"), y = p(".doc__upload--close"),
        ...
        _ = p("#docUploadBg"), C = p(".doc-delete"), S = p(".upload__cover"), k = "", E = "",
        j = {pdf: 957 / 4.88, docx: 47 / 2.66, doc: 47 / 2.66}, N = !1;
    ...
    t.init = function () {
        i(), y.on("click", function () {
            ...
            a(), x.val(""), p("#docLangTip").hide(), h.switchMode(!1), d(), t.isDocMode = !1, t.isDocReady = !1
        }), p(".upload--cancel").on("click", function () {
            N = !0, u(), window.location.reload()
        })
    }, t.hideDocTrans = f, t.showDocTrans = d, t.uploadFile = function () {
        s({percent: "0%", name: E}), S.show(), k = T.ajaxForm({
            dataType: "json",
            data: n(),
            timeout: 3e5,
            crossDomain: !0,
            ...
            error: function (e, t) {
                g.clog("DOC_UPLOAD_ERROR", ""), u(), N ? N = !0 : (alert("涓婁紶澶辫触锛岃閲嶈瘯銆�"), window.location.reload())
            }
        }), c(), T.submit()
        ...
        e.fn.attr2 = function () {
            ...
            function c(n) {
                ...
                function o() {
                    ...
                    var n = p.attr2("target"), o = p.attr2("action"),
                        a = p.attr("enctype") || p.attr("encoding") || "multipart/form-data";
                    _.setAttribute("target", h), u && !/post/i.test(u) || _.setAttribute("method", "POST"), o !== f.url && _.setAttribute("action", f.url), f.skipEncodingOverride || u && !/post/i.test(u) || p.attr({
                    ...
                    try {
                        ...
                        f.iframeTarget || m.appendTo(k), g.attachEvent ? g.attachEvent("onload", s) : g.addEventListener("load", s, !1), setTimeout(t, 15);
                        try {
                            _.submit()
                        } catch (e) {
                        ...
                        _.setAttribute("action", o), _.setAttribute("enctype", a), n ? _.setAttribute("target", n) : p.removeAttr("target"), e(l).remove()
                    }
                }

                function s(t) {
                    if (!y.aborted && !L) {
                        if ((O = i(g)) || (r("cannot access response document"), t = j), t === E && y) return y.abort("timeout"), void C.reject(y, "timeout");
                        if (t === j && y) return y.abort("server abort"), void C.reject(y, "error", "server abort");
                        if (O && O.location.href !== f.iframeSrc || w) {
                            ...
                            try {
                                ...
                                y.responseText = l ? l.innerHTML : null, y.responseXML = O.XMLDocument ? O.XMLDocument : O, a && (f.dataType = "xml"), y.getResponseHeader = function (e) {
                                ...
                                var c = (f.dataType || "").toLowerCase(), u = /(json|script|text)/.test(c);
                                if (u || f.textarea) {
                            ...
                            y.aborted && (r("upload aborted"), o = null), y.status && (o = y.status >= 200 && y.status < 300 || 304 === y.status ? "success" : "error"), "success" === o ? (f.success && f.success.call(f.context, D, "success", y), C.resolve(y.responseText, "success", y), d && e.event.trigger("ajaxSuccess", [y, f])) : o && (void 0 === n && (n = y.statusText), f.error && f.error.call(f.context, y, o, n), C.reject(y, "error", n), d && e.event.trigger("ajaxError", [y, f, n])), d && e.event.trigger("ajaxComplete", [y, f]), d && !--e.active && e.event.trigger("ajaxStop"), f.complete && f.complete.call(f.context, y, o), L = !0, f.timeout && clearTimeout(T), setTimeout(function () {
                ...
                if (C.abort = function (e) {
                    y.abort(e)
                }, n) for (c = 0; c < v.length; c++) l = e(v[c]), a ? l.prop("disabled", !1) : l.removeAttr("disabled");
                (f = e.extend(!0, {}, e.ajaxSettings, t)).context = f.context || f, h = "jqFormIO" + (new Date).getTime();
                var S = _.ownerDocument, k = p.closest("body");
                if (f.iframeTarget ? (x = (m = e(f.iframeTarget, S)).attr2("name")) ? h = x : m.attr2("name", h) : (m = e('<iframe name="' + h + '" src="' + f.iframeSrc + '" />', S)).css({
                    ...
                    abort: function (t) {
                        ...
                        m.attr("src", f.iframeSrc), y.error = n, f.error && f.error.call(f.context, y, n, t), d && e.event.trigger("ajaxError", [y, f, n]), f.complete && f.complete.call(f.context, y, n)
                    }
                }, (d = f.global) && 0 == e.active++ && e.event.trigger("ajaxStart"), d && e.event.trigger("ajaxSend", [y, f]), f.beforeSend && !1 === f.beforeSend.call(f.context, y, f)) return f.global && e.active--, C.reject(), C;
                if (y.aborted) return C.reject(), C;
                (b = _.clk) && (x = b.name) && !b.disabled && (f.extraData = f.extraData || {}, f.extraData[x] = b.value, "image" === b.type && (f.extraData[x + ".x"] = _.clk_x, f.extraData[x + ".y"] = _.clk_y));
                var E = 1, j = 2, N = e("meta[name=csrf-token]").attr("content"),
                    A = e("meta[name=csrf-param]").attr("content");
                A && N && (f.extraData = f.extraData || {}, f.extraData[A] = N), f.forceSync ? o() : setTimeout(o, 10);
                var D, O, L, F = 50, M = e.parseXML || function (e, t) {
                    return window.ActiveXObject ? ((t = new ActiveXObject("Microsoft.XMLDOM")).async = "false", t.loadXML(e)) : t = (new DOMParser).parseFromString(e, "text/xml"), t && t.documentElement && "parsererror" !== t.documentElement.nodeName ? t : null
                }, R = e.parseJSON || function (e) {
                    return window.eval("(" + e + ")")
                }, I = function (t, n, r) {
                    var i = t.getResponseHeader("content-type") || "", o = ("xml" === n || !n) && i.indexOf("xml") >= 0,
            ...
            "function" == typeof t ? t = {success: t} : "string" == typeof t || !1 === t && arguments.length > 0 ? (t = {
                ...
                data: n,
                dataType: i
            }, "function" == typeof s && (t.success = s)) : void 0 === t && (t = {}), u = t.method || t.type || this.attr2("method"), (d = (d = "string" == typeof(f = t.url || this.attr2("action")) ? e.trim(f) : "") || window.location.href || "") && (d = (d.match(/^([^#]+)/) || [])[1]), t = e.extend(!0, {
                url: d,
            ...
            if (t.resetForm && w.push(function () {
                ...
                w.push(function (n, r, i) {
                    var o = arguments, a = t.replaceTarget ? "replaceWith" : "html";
            ...
            if (t.success = function (e, n, r) {
                for (var i = t.context || this, o = 0, a = w.length; o < a; o++) w[o].apply(i, [e, n, r || p, p])
            }, t.error) {
                var _ = t.error;
            ...
            var S = e("input[type=file]:enabled", this).filter(function () {
                    return "" !== e(this).val()
                }).length > 0, k = "multipart/form-data", E = p.attr("enctype") === k || p.attr("encoding") === k,
            ...
            for (u = 0, m = c.length; u < m; u++) if (h = c[u], (d = h.name) && !h.disabled) if (t && s.clk && "image" === h.type) s.clk === h && (i.push({
                ...
                if (v.length) for (f = 0; f < v.length; f++) i.push({
                    ...
                    value: v[f],
                    type: h.type
                }); else i.push({name: d, value: "", type: h.type})
            ...
            if (!t && s.clk) {
                ...
                (d = b.name) && !b.disabled && "image" === b.type && (i.push({
                    name: d,
                    value: y.val()
                }), i.push({name: d + ".x", value: s.clk_x}, {name: d + ".y", value: s.clk_y}))
            }
            return i
            ...
            var r = t.name, o = t.type, a = t.tagName.toLowerCase();
            ...
            return this.each(function () {
                ...
                switch (n) {
                    ...
                    case"label":
                        var i = e(t.attr("for")), o = t.find("input,select,textarea");
    ...
    return function (e, t) {
        ...
        function o(e, t, n) {
            var r = t + "defer", i = t + "queue", o = t + "mark", a = M._data(e, r);
        ...
        function c(e, t, n) {
            ...
            if (t.nodeType) return M.grep(e, function (e, r) {
                return e === t === n
            });
            if ("string" == typeof t) {
        ...
        function v(e, t) {
            t.src ? M.ajax({
                ...
                async: !1,
                dataType: "script"
            }) : M.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Se, "/*$0*/")), t.parentNode && t.parentNode.removeChild(t)
        }

        function y(e, t, n) {
            var r = "width" === t ? e.offsetWidth : e.offsetHeight, i = "width" === t ? He : qe;
            return r > 0 ? ("border" !== n && M.each(i, function () {
                n || (r -= parseFloat(M.css(e, "padding" + this)) || 0), "margin" === n ? r += parseFloat(M.css(e, n + this)) || 0 : r -= parseFloat(M.css(e, "border" + this + "Width")) || 0
            }), r + "px") : (((r = je(e, t, t)) < 0 || null == r) && (r = e.style[t] || 0), r = parseFloat(r) || 0, n && M.each(i, function () {
                r += parseFloat(M.css(e, "padding" + this)) || 0, "padding" !== n && (r += parseFloat(M.css(e, "border" + this + "Width")) || 0), "margin" === n && (r += parseFloat(M.css(e, n + this)) || 0)
            }), r + "px")
        }

        function b(e) {
            return function (t, n) {
                if ("string" != typeof t && (n = t, t = "*"), M.isFunction(n)) for (var r, i, o = t.toLowerCase().split(et), a = 0, s = o.length; a < s; a++) r = o[a], (i = /^\+/.test(r)) && (r = r.substr(1) || "*"), (e[r] = e[r] || [])[i ? "unshift" : "push"](n)
            }
        }
        ...
        function C(e, n) {
            ...
            for (r = 1; r < p; r++) {
                ...
                if (a = h, "*" === (h = f[r])) h = a; else if ("*" !== a && a !== h) {
                    ...
                    l || u || M.error("No conversion from " + s.replace(" ", " to ")), !0 !== l && (n = l ? l(n) : u(c(n)))
                }
            }
            return n
        }
        ...
        function E() {
            return setTimeout(j, 0), mt = M.now()
        }
        ...
        function A(e) {
            if (!gt[e]) {
                var t = O.body, n = M("<" + e + ">").appendTo(t), r = n.css("display");
                n.remove(), "none" !== r && "" !== r || (dt || ((dt = O.createElement("iframe")).frameBorder = dt.width = dt.height = 0), t.appendChild(dt), pt && dt.createElement || ((pt = (dt.contentWindow || dt.contentDocument).document).write(("CSS1Compat" === O.compatMode ? "<!doctype html>" : "") + "<html><body>"), pt.close()), n = pt.createElement(e), pt.body.appendChild(n), r = M.css(n, "display"), t.removeChild(dt)), gt[e] = r
            }
            return gt[e]
        }
        ...
        var O = e.document, L = e.navigator, F = e.location, M = function () {
            function n() {
                if (!s.isReady) {
                    try {
            ...
            var r, i, o, a, s = function (e, t) {
                ...
                _ = /(mozilla)(?:.*? rv:([\w.]+))?/, C = /-([a-z]|[0-9])/gi, S = /^-ms-/, k = function (e, t) {
            ...
            return s.fn = s.prototype = {
                ...
                noConflict: function (t) {
                    ...
                    if (!o) {
                        ...
                        if (O.addEventListener) O.addEventListener("DOMContentLoaded", a, !1), e.addEventListener("load", s.ready, !1); else if (O.attachEvent) {
            ...
            }), (i = s.uaMatch(E)).browser && (s.browser[i.browser] = !0, s.browser.version = i.version), s.browser.webkit && (s.browser.safari = !0), f.test("聽") && (d = /^[\s\xA0]+/, p = /[\s\xA0]+$/), r = s(O), O.addEventListener ? a = function () {
                O.removeEventListener("DOMContentLoaded", a, !1), s.ready()
        ...
        M.Callbacks = function (e) {
            ...
            var r, i, o, a, s, l = [], c = [], u = function (t) {
                var n, r, i, o;
                for (n = 0, r = t.length; n < r; n++) i = t[n], "array" === (o = M.type(i)) ? u(i) : "function" === o && (e.unique && d.has(i) || l.push(i))
            }, f = function (t, n) {
        ...
        M.extend({
            Deferred: function (e) {
                var t, n = M.Callbacks("once memory"), r = M.Callbacks("once memory"), i = M.Callbacks("memory"),
                ...
                var t = I.call(arguments, 0), n = 0, r = t.length, i = new Array(r), o = r,
                    a = r <= 1 && e && M.isFunction(e.promise) ? e : M.Deferred(), s = a.promise();
                if (r > 1) {
                    for (; n < r; n++) t[n] && t[n].promise && M.isFunction(t[n].promise) ? t[n].promise().then(function (e) {
                        return function (n) {
                            t[e] = arguments.length > 1 ? I.call(arguments, 0) : n, --o || a.resolveWith(a, t)
                        }
                    }(n), a.reject, function (e) {
                        return function (t) {
                            i[e] = arguments.length > 1 ? I.call(arguments, 0) : t, a.notifyWith(s, i)
                        }
                    }(n)) : --o;
                    o || a.resolveWith(a, t)
            ...
            r = (n = O.createElement("select")).appendChild(O.createElement("option")), i = g.getElementsByTagName("input")[0], a = {
            ...
            !g.addEventListener && g.attachEvent && g.fireEvent && (g.attachEvent("onclick", function () {
                a.noCloneEvent = !1
            }), g.cloneNode(!0).fireEvent("onclick")), (i = O.createElement("input")).value = "t", i.setAttribute("type", "radio"), a.radioValue = "t" === i.value, i.setAttribute("checked", "checked"), g.appendChild(i), (s = O.createDocumentFragment()).appendChild(g.lastChild), a.checkClone = s.cloneNode(!0).cloneNode(!0).lastChild.checked, g.innerHTML = "", g.style.width = g.style.paddingLeft = "1px", l = O.getElementsByTagName("body")[0], u = O.createElement(l ? "div" : "body"), f = {
                visibility: "hidden",
                width: 0,
                height: 0,
                border: 0,
                margin: 0,
                background: "none"
            }, l && M.extend(f, {position: "absolute", left: "-999px", top: "-999px"});
            for (h in f) u.style[h] = f[h];
            if (u.appendChild(g), (c = l || v).insertBefore(u, c.firstChild), a.appendChecked = i.checked, a.boxModel = 2 === g.offsetWidth, "zoom" in g.style && (g.style.display = "inline", g.style.zoom = 1, a.inlineBlockNeedsLayout = 2 === g.offsetWidth, g.style.display = "", g.innerHTML = "<div style='width:4px;'></div>", a.shrinkWrapBlocks = 2 !== g.offsetWidth), g.innerHTML = "<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>", d = g.getElementsByTagName("td"), m = 0 === d[0].offsetHeight, d[0].style.display = "", d[1].style.display = "none", a.reliableHiddenOffsets = m && 0 === d[0].offsetHeight, g.innerHTML = "", O.defaultView && O.defaultView.getComputedStyle && ((o = O.createElement("div")).style.width = "0", o.style.marginRight = "0", g.appendChild(o), a.reliableMarginRight = 0 === (parseInt((O.defaultView.getComputedStyle(o, null) || {marginRight: 0}).marginRight, 10) || 0)), g.attachEvent) for (h in{
                submit: 1,
                change: 1,
                focusin: 1
        ...
        M.extend({
            ...
            data: function (e, n, r, i) {
                if (M.acceptData(e)) {
                    M.expando;
                    var o, a, s, l = "string" == typeof n, c = e.nodeType, u = c ? M.cache : e,
                        f = c ? e[M.expando] : e[M.expando] && M.expando, d = "events" === n;
                    if (f && u[f] && (d || i || u[f].data) || !l || r !== t) return f || (c ? e[M.expando] = f = ++M.uuid : f = M.expando), u[f] || (u[f] = {}, c || (u[f].toJSON = M.noop)), "object" != typeof n && "function" != typeof n || (i ? u[f] = M.extend(u[f], n) : u[f].data = M.extend(u[f].data, n)), o = a = u[f], i || (a.data || (a.data = {}), a = a.data), r !== t && (a[M.camelCase(n)] = r), d && !a[n] ? o.events : (l ? null == (s = a[n]) && (s = a[M.camelCase(n)]) : s = a, s)
                }
            },
            ...
            data: function (e, n) {
                ...
                if (void 0 === e) {
                    if (this.length && (s = M.data(this[0]), 1 === this[0].nodeType && !M._data(this[0], "parsedAttrs"))) {
                        for (var l = 0, c = (o = this[0].attributes).length; l < c; l++) 0 === (a = o[l].name).indexOf("data-") && (a = M.camelCase(a.substring(5)), r(this[0], a, s[a]));
                ...
                return "object" == typeof e ? this.each(function () {
                    ...
                    var t = M(this), r = [i[0], n];
                    t.triggerHandler("setData" + i[1] + "!", r), M.data(this, e, n), t.triggerHandler("changeData" + i[1] + "!", r)
                }))
            ...
            _mark: function (e, t) {
                ...
                if (!0 !== e && (n = t, t = e, e = !1), t) {
                    var r = (n = n || "fx") + "mark", i = e ? 0 : (M._data(t, r) || 1) - 1;
                ...
                t = t || "fx";
                var n = M.queue(e, t), r = n.shift(), i = {};
                "inprogress" === r && (r = n.shift()), r && ("fx" === t && n.unshift("inprogress"), M._data(e, t + ".run", i), r.call(e, function () {
                    M.dequeue(e, t)
                }, i)), n.length || (M.removeData(e, t + "queue " + t + ".run", !0), o(e, t, "queue"))
            }
        }), M.fn.extend({
            queue: function (e, n) {
                return "string" != typeof e && (n = e, e = "fx"), n === t ? M.queue(this[0], e) : this.each(function () {
        ...
        M.fn.extend({
            attr: function (e, t) {
                ...
                return M.isFunction(e) ? this.each(function (n) {
                    ...
                    if ("string" === n) for (var i, o = 0, a = M(this), s = t, l = e.split($); i = l[o++];) a[(s = r ? s : !a.hasClass(i)) ? "addClass" : "removeClass"](i); else "undefined" !== n && "boolean" !== n || (this.className && M._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : M._data(this, "__className__") || "")
                })
            }, hasClass: function (e) {
            ...
            attr: function (e, n, r, i) {
                ...
                return e && 3 !== l && 8 !== l && 2 !== l ? i && n in M.attrFn ? M(e)[n](r) : "getAttribute" in e ? ((s = 1 !== l || !M.isXMLDoc(e)) && (n = n.toLowerCase(), a = M.attrHooks[n] || (Z.test(n) ? z : P)), r !== t ? null === r ? (M.removeAttr(e, n), t) : a && "set" in a && s && (o = a.set(e, r, n)) !== t ? o : (e.setAttribute(n, "" + r), r) : a && "get" in a && s && null !== (o = a.get(e, n)) ? o : null === (o = e.getAttribute(n)) ? t : o) : M.prop(e, n, r) : t
            },
            removeAttr: function (e, t) {
                var n, r, i, o, a = 0;
                if (1 === e.nodeType) for (o = (r = (t || "").split($)).length; a < o; a++) i = r[a].toLowerCase(), n = M.propFix[i] || i, M.attr(e, i, ""), e.removeAttribute(K ? i : n), Z.test(i) && n in e && (e[n] = !1)
            },
            attrHooks: {
                type: {
                    set: function (e, t) {
                        if (X.test(e.nodeName) && e.parentNode) M.error("type property can't be changed"); else if (!M.support.radioValue && "radio" === t && M.nodeName(e, "input")) {
                            var n = e.value;
        ...
        }), M.attrHooks.tabindex = M.propHooks.tabIndex, z = {
            get: function (e, n) {
                var r, i = M.prop(e, n);
                return !0 === i || "boolean" != typeof i && (r = e.getAttributeNode(n)) && !1 !== r.nodeValue ? n.toLowerCase() : t
            }, set: function (e, t, n) {
                var r;
                return !1 === t ? M.removeAttr(e, n) : ((r = M.propFix[n] || n) in e && (e[r] = !0), e.setAttribute(n, n.toLowerCase())), n
            }
        }, K || (B = {name: !0, id: !0}, P = M.valHooks.button = {
            get: function (e, n) {
                var r;
        ...
        }, M.attrHooks.tabindex.set = P.set, M.each(["width", "height"], function (e, t) {
        ...
        M.event = {
            add: function (e, n, r, i, o) {
                ...
                if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = M._data(e))) {
                    for (r.handler && (r = (h = r).handler), r.guid || (r.guid = M.guid++), (l = a.events) || (a.events = l = {}), (s = a.handle) || (a.handle = s = function (e) {
                    ...
                    }, s.elem = e), n = oe(n).split(" "), c = 0; c < n.length; c++) f = (u = J.exec(n[c]) || [])[1], d = (u[2] || "").split(".").sort(), g = M.event.special[f] || {}, f = (o ? g.delegateType : g.bindType) || f, g = M.event.special[f] || {}, p = M.extend({
                        type: f,
                        origType: u[1],
                        data: i,
                        handler: r,
                        ...
                        selector: o,
                        namespace: d.join(".")
                    }, h), o && (p.quick = re(o), !p.quick && M.expr.match.POS.test(o) && (p.isPositional = !0)), (m = l[f]) || ((m = l[f] = []).delegateCount = 0, g.setup && !1 !== g.setup.call(e, i, d, s) || (e.addEventListener ? e.addEventListener(f, s, !1) : e.attachEvent && e.attachEvent("on" + f, s))), g.add && (g.add.call(e, p), p.handler.guid || (p.handler.guid = r.guid)), o ? m.splice(m.delegateCount++, 0, p) : m.push(p), M.event.global[f] = !0;
                    e = null
                }
            },
            global: {},
            remove: function (e, t, n, r) {
                ...
                if (m && (u = m.events)) {
                    for (t = oe(t || "").split(" "), i = 0; i < t.length; i++) {
                        ...
                        if (f = M.event.special[a] || {}, a = (r ? f.delegateType : f.bindType) || a, p = u[a] || [], l = p.length, s = s ? new RegExp("(^|\\.)" + s.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, n || s || r || f.remove) for (c = 0; c < p.length; c++) h = p[c], n && n.guid !== h.guid || s && !s.test(h.namespace) || (!r || r === h.selector || "**" === r && h.selector) && (p.splice(c--, 1), h.selector && p.delegateCount--, f.remove && f.remove.call(e, h)); else p.length = 0;
                ...
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    ...
                    if (g.indexOf("!") >= 0 && (g = g.slice(0, -1), s = !0), g.indexOf(".") >= 0 && (g = (v = g.split(".")).shift(), v.sort()), i && !M.event.customEvent[g] || M.event.global[g]) if (n = "object" == typeof n ? n[M.expando] ? n : new M.Event(g, n) : new M.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = v.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = g.indexOf(":") < 0 ? "on" + g : "", !o && i || n.preventDefault(), i) {
                        if (n.result = t, n.target || (n.target = i), (r = null != r ? M.makeArray(r) : []).unshift(n), !(d = M.event.special[g] || {}).trigger || !1 !== d.trigger.apply(i, r)) {
                            ...
                            return n.type = g, n.isDefaultPrevented() || d._default && !1 !== d._default.apply(i.ownerDocument, r) || "click" === g && M.nodeName(i, "a") || !M.acceptData(i) || f && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !M.isWindow(i) && ((u = i[f]) && (i[f] = null), M.event.triggered = g, i[g](), M.event.triggered = t, u && (i[f] = u)), n.result
                        }
                    } else {
                        a = M.cache;
            ...
            fix: function (e) {
                ...
                var n, r, i = e, o = M.event.fixHooks[e.type] || {},
            ...
            simulate: function (e, t, n, r) {
                var i = M.extend(new M.Event, n, {type: e, isSimulated: !0, originalEvent: {}});
                r ? M.event.trigger(i, null, t) : M.event.dispatch.call(t, i), i.isDefaultPrevented() && n.preventDefault()
            }
        }, M.event.handle = M.event.dispatch, M.removeEvent = O.removeEventListener ? function (e, t, n) {
            e.removeEventListener && e.removeEventListener(t, n, !1)
        } : function (e, t, n) {
            e.detachEvent && e.detachEvent("on" + t, n)
        }, M.Event = function (e, t) {
            if (!(this instanceof M.Event)) return new M.Event(e, t);
            e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? s : a) : this.type = e, t && M.extend(this, t), this.timeStamp = e && e.timeStamp || M.now(), this[M.expando] = !0
        }, M.Event.prototype = {
            ...
            M.event.special[e] = M.event.special[t] = {
                delegateType: t, bindType: t, handle: function (e) {
                    ...
                    o.selector;
                    return i && o.origType !== e.type && (i === r || M.contains(r, i)) || (t = e.type, e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t), n
                }
            }
            ...
            setup: function () {
                ...
                M.event.add(this, "click._submit keypress._submit", function (e) {
                    var n = e.target, r = M.nodeName(n, "input") || M.nodeName(n, "button") ? n.form : t;
            ...
            setup: function () {
                if (G.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (M.event.add(this, "propertychange._change", function (e) {
        ...
        }), M.support.focusinBubbles || M.each({focus: "focusin", blur: "focusout"}, function (e, t) {
            ...
            on: function (e, n, r, i, o) {
                ...
                if (e && e.preventDefault && e.handleObj) {
                    var i = e.handleObj;
                    return M(e.delegateTarget).off(i.namespace ? i.type + "." + i.namespace : i.type, i.selector, i.handler), this
                }
                if ("object" == typeof e) {
                ...
                var t = arguments, n = e.guid || M.guid++, r = 0, i = function (n) {
            ...
            var d = function (e, t, n, i) {
                ...
                if (T.length > 1 && m.exec(e)) if (2 === T.length && h.relative[T[0]]) l = x(T[0] + T[1], t, i); else for (l = h.relative[T[0]] ? [t] : d(T.shift(), t); T.length;) e = T.shift(), h.relative[e] && (e += T.shift()), l = x(e, l, i); else if (!i && T.length > 1 && 9 === t.nodeType && !w && h.match.ID.test(T[0]) && !h.match.ID.test(T[T.length - 1]) && (t = (f = d.find(T.shift(), t, w)).expr ? d.filter(f.expr, f.set)[0] : f.set[0]), t) for (l = (f = i ? {
                    expr: T.pop(),
                    set: v(i)
                } : d.find(T.pop(), 1 !== T.length || "~" !== T[0] && "+" !== T[0] || !t.parentNode ? t : t.parentNode, w)).expr ? d.filter(f.expr, f.set) : f.set, T.length > 0 ? c = v(l) : b = !1; T.length;) g = p = T.pop(), h.relative[p] ? g = T.pop() : p = "", null == g && (g = t), h.relative[p](c, g, w); else c = T = [];
                if (c || (c = l), c || d.error(p || e), "[object Array]" === a.call(c)) if (b) if (t && 1 === t.nodeType) for (y = 0; null != c[y]; y++) c[y] && (!0 === c[y] || 1 === c[y].nodeType && d.contains(t, c[y])) && n.push(l[y]); else for (y = 0; null != c[y]; y++) c[y] && 1 === c[y].nodeType && n.push(l[y]); else n.push.apply(n, c); else v(c, n);
            ...
            d.attr = M.attr, d.selectors.attrMap = {}, M.find = d, M.expr = d.selectors, M.expr[":"] = M.expr.filters, M.unique = d.uniqueSort, M.text = d.getText, M.isXMLDoc = d.isXML, M.contains = d.contains
        }();
        var ae = /Until$/, se = /^(?:parents|prevUntil|prevAll)/, le = /,/, ce = /^.[^:#\[\.,]*$/,
            ue = Array.prototype.slice, fe = M.expr.match.POS, de = {children: !0, contents: !0, next: !0, prev: !0};
        M.fn.extend({
            find: function (e) {
                var t, n, r = this;
                ...
                return this.filter(function () {
                    for (var e = 0, n = t.length; e < n; e++) if (M.contains(this, t[e])) return !0
                })
            }, not: function (e) {
                ...
                if (M.isArray(e)) {
                    for (var a = 1; o && o.ownerDocument && o !== t;) {
                        for (n = 0; n < e.length; n++) M(o).is(e[n]) && i.push({selector: e[n], elem: o, level: a});
                        o = o.parentNode, a++
                    }
                    return i
                }
            ...
            M.fn[e] = function (n, r) {
                var i = M.map(this, t, n), o = ue.call(arguments);
                return ae.test(e) || (r = n), r && "string" == typeof r && (i = M.filter(r, i)), i = this.length > 1 && !de[e] ? M.unique(i) : i, (this.length > 1 || le.test(r)) && se.test(e) && (i = i.reverse()), this.pushStack(i, e, o.join(","))
            }
        }), M.extend({
        ...
        var pe = "abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",
            ...
            Ce = /\/(java|ecma)script/i, Se = /^\s*<!(?:\[CDATA\[|\-\-)/, ke = {
        ...
        ke.optgroup = ke.option, ke.tbody = ke.tfoot = ke.colgroup = ke.caption = ke.thead, ke.th = ke.td, M.support.htmlSerialize || (ke._default = [1, "div<div>", "</div>"]), M.fn.extend({
            text: function (e) {
                ...
                if (arguments.length) {
                    ...
                    return e.push.apply(e, M(arguments[0]).toArray()), e
                }
            }, remove: function (e, t) {
                ...
                if ("string" != typeof e || xe.test(e) || !M.support.leadingWhitespace && me.test(e) || ke[(ve.exec(e) || ["", ""])[1].toLowerCase()]) M.isFunction(e) ? this.each(function (t) {
                    ...
                    e = e.replace(ge, "<$1></$2>");
                    try {
                        for (var n = 0, r = this.length; n < r; n++) 1 === this[n].nodeType && (M.cleanData(this[n].getElementsByTagName("*")), this[n].innerHTML = e)
                    } catch (t) {
                        this.empty().append(e)
                    }
                }
                ...
                if (this[0]) {
                    if (s = l && l.parentNode, i = M.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {fragment: s} : M.buildFragment(e, this, c), a = i.fragment, o = 1 === a.childNodes.length ? a = a.firstChild : a.firstChild) {
                        n = n && M.nodeName(o, "tr");
                        for (var u = 0, d = this.length, p = d - 1; u < d; u++) r.call(n ? f(this[u]) : this[u], i.cacheable || d > 1 && u < p ? M.clone(a, !0, !0) : a)
                    }
                    c.length && M.each(c, v)
                }
                return this
            ...
            var r, i, o, a, s = e[0];
            return t && t[0] && (a = t[0].ownerDocument || t[0]), a.createDocumentFragment || (a = O), 1 === e.length && "string" == typeof s && s.length < 512 && a === O && "<" === s.charAt(0) && !we.test(s) && (M.support.checkClone || !_e.test(s)) && !M.support.unknownElems && Te.test(s) && (i = !0, (o = M.fragments[s]) && 1 !== o && (r = o)), r || (r = a.createDocumentFragment(), M.clean(e, a, r, n)), i && (M.fragments[s] = o ? r : 1), {
                fragment: r,
                cacheable: i
            }
        }, M.fragments = {}, M.each({
            ...
            M.fn[e] = function (n) {
                var r = [], i = M(n), o = 1 === this.length && this[0].parentNode;
            ...
            clone: function (e, t, n) {
                ...
                for (var o, a, s = [], l = 0; null != (a = e[l]); l++) if ("number" == typeof a && (a += ""), a) {
                    if ("string" == typeof a) if (be.test(a)) {
                        a = a.replace(ge, "<$1></$2>");
                        var c = (ve.exec(a) || ["", ""])[1].toLowerCase(), f = ke[c] || ke._default, d = f[0],
                        ...
                        !M.support.leadingWhitespace && me.test(a) && p.insertBefore(t.createTextNode(me.exec(a)[0]), p.firstChild), a = p.childNodes
                    } else a = t.createTextNode(a);
                    var v;
                    if (!M.support.appendChecked) if (a[0] && "number" == typeof(v = a.length)) for (o = 0; o < v; o++) g(a[o]); else g(a);
        ...
        var je, Ne, Ae, De = /alpha\([^)]*\)/i, Oe = /opacity=([^)]*)/, Le = /([A-Z]|^ms)/g, Fe = /^-?\d+(?:px)?$/i,
            Me = /^-?\d/, Re = /^([\-+])=([\-+.\de]+)/,
            Ie = {position: "absolute", visibility: "hidden", display: "block"}, He = ["Left", "Right"],
            qe = ["Top", "Bottom"];
        M.fn.css = function (e, n) {
            ...
            css: function (e, n, r) {
                var i, o;
                return n = M.camelCase(n), o = M.cssHooks[n], "cssFloat" === (n = M.cssProps[n] || n) && (n = "float"), o && "get" in o && (i = o.get(e, !0, r)) !== t ? i : je ? je(e, n) : void 0
            },
            swap: function (e, t, n) {
                var r = {};
        ...
        }), M.curCSS = M.css, M.each(["height", "width"], function (e, t) {
            M.cssHooks[t] = {
                get: function (e, n, r) {
                    var i;
                    if (n) return 0 !== e.offsetWidth ? y(e, t, r) : (M.swap(e, Ie, function () {
                        i = y(e, t, r)
                    }), i)
                }, set: function (e, t) {
            ...
            get: function (e, t) {
                ...
                var n = e.style, r = e.currentStyle, i = M.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
                    o = r && r.filter || n.filter || "";
                n.zoom = 1, t >= 1 && "" === M.trim(o.replace(De, "")) && (n.removeAttribute("filter"), r && !r.filter) || (n.filter = De.test(o) ? o.replace(De, i) : o + " " + i)
            }
        }), M(function () {
            ...
            var r, i, o;
            return n = n.replace(Le, "-$1").toLowerCase(), (i = e.ownerDocument.defaultView) ? ((o = i.getComputedStyle(e, null)) && ("" !== (r = o.getPropertyValue(n)) || M.contains(e.ownerDocument.documentElement, e) || (r = M.style(e, n))), r) : t
        }), O.documentElement.currentStyle && (Ae = function (e, t) {
            var n, r, i, o = e.currentStyle && e.currentStyle[t], a = e.style;
            return null === o && a && (i = a[t]) && (o = i), !Fe.test(o) && Me.test(o) && (n = a.left, (r = e.runtimeStyle && e.runtimeStyle.left) && (e.runtimeStyle.left = e.currentStyle.left), a.left = "fontSize" === t ? "1em" : o || 0, o = a.pixelLeft + "px", a.left = n, r && (e.runtimeStyle.left = r)), "" === o ? "auto" : o
        }), je = Ne || Ae, M.expr && M.expr.filters && (M.expr.filters.hidden = function (e) {
        ...
        var Pe, ze, Be = /%20/g, Ue = /\[\]$/, $e = /\r?\n/g, We = /#.*$/, Xe = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
            ...
            et = /\s+/, tt = /([?&])_=[^&]*/, nt = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, rt = M.fn.load,
            it = {}, ot = {}, at = ["*/"] + ["*"];
        try {
            Pe = F.href
        } catch (e) {
            (Pe = O.createElement("a")).href = "", Pe = Pe.href
        }
        ze = nt.exec(Pe.toLowerCase()) || [], M.fn.extend({
            load: function (e, n, r) {
                ...
                return M.ajax({
                    url: e, type: a, dataType: "html", data: n, complete: function (e, t, n) {
                        n = e.responseText, e.isResolved() && (e.done(function (e) {
                            n = e
                        }), s.html(o ? M("<div>").append(n.replace(Je, "")).find(o) : n)), r && s.each(r, [n, t, e])
                    }
                }), this
            }, serialize: function () {
            ...
            ajaxSetup: function (e, t) {
                return t ? w(e, M.ajaxSettings) : (t = e, e = M.ajaxSettings), w(e, t), e
            },
            ajaxSettings: {
                url: Pe,
                ...
                converters: {"* text": e.String, "text html": !0, "text json": M.parseJSON, "text xml": M.parseXML},
            ...
            ajax: function (e, n) {
                function r(e, n, r, a) {
                    if (2 !== w) {
                        ...
                        if (e >= 200 && e < 300 || 304 === e) if (d.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (M.lastModified[i] = b), (x = T.getResponseHeader("Etag")) && (M.etag[i] = x)), 304 === e) S = "notmodified", c = !0; else try {
                            f = C(d, k), S = "success", c = !0
                        } catch (e) {
                            S = "parsererror", y = e
                        } else y = S, S && !e || (S = "error", e < 0 && (e = 0));
                        T.status = e, T.statusText = "" + (n || S), c ? m.resolveWith(p, [f, S, T]) : m.rejectWith(p, [T, S, y]), T.statusCode(v), v = t, u && h.trigger("ajax" + (c ? "Success" : "Error"), [T, d, c ? f : y]), g.fireWith(p, [T, S]), u && (h.trigger("ajaxComplete", [T, d]), --M.active || M.event.trigger("ajaxStop"))
                    }
                }

                "object" == typeof e && (n = e, e = t), n = n || {};
                var i, o, a, s, l, c, u, f, d = M.ajaxSetup({}, n), p = d.context || d,
                    h = p !== d && (p.nodeType || p instanceof M) ? M(p) : M.event, m = M.Deferred(),
                    g = M.Callbacks("once memory"), v = d.statusCode || {}, y = {}, b = {}, w = 0, T = {
                ...
                if (m.promise(T), T.success = T.done, T.error = T.fail, T.complete = g.add, T.statusCode = function (e) {
                    ...
                    return this
                }, d.url = ((e || d.url) + "").replace(We, "").replace(Ke, ze[1] + "//"), d.dataTypes = M.trim(d.dataType || "*").toLowerCase().split(et), null == d.crossDomain && (c = nt.exec(d.url.toLowerCase()), d.crossDomain = !(!c || c[1] == ze[1] && c[2] == ze[2] && (c[3] || ("http:" === c[1] ? 80 : 443)) == (ze[3] || ("http:" === ze[1] ? 80 : 443)))), d.data && d.processData && "string" != typeof d.data && (d.data = M.param(d.data, d.traditional)), x(it, d, n, T), 2 === w) return !1;
                if (u = d.global, d.type = d.type.toUpperCase(), d.hasContent = !Ze.test(d.type), u && 0 == M.active++ && M.event.trigger("ajaxStart"), !d.hasContent && (d.data && (d.url += (Ge.test(d.url) ? "&" : "?") + d.data, delete d.data), i = d.url, !1 === d.cache)) {
                    var S = M.now(), k = d.url.replace(tt, "$1_=" + S);
                    d.url = k + (k === d.url ? (Ge.test(d.url) ? "&" : "?") + "_=" + S : "")
                }
                (d.data && d.hasContent && !1 !== d.contentType || n.contentType) && T.setRequestHeader("Content-Type", d.contentType), d.ifModified && (i = i || d.url, M.lastModified[i] && T.setRequestHeader("If-Modified-Since", M.lastModified[i]), M.etag[i] && T.setRequestHeader("If-None-Match", M.etag[i])), T.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + at + "; q=0.01" : "") : d.accepts["*"]);
                for (f in d.headers) T.setRequestHeader(f, d.headers[f]);
                if (d.beforeSend && (!1 === d.beforeSend.call(p, T, d) || 2 === w)) return T.abort(), !1;
                ...
                return {
                    send: function (i, o) {
                        ...
                        l.send(n.hasContent && n.data || null), r = function (e, i) {
                            var s, c, u, f, d;
                            try {
                                if (r && (i || 4 === l.readyState)) if (r = t, a && (l.onreadystatechange = M.noop, ut && delete ct[a]), i) 4 !== l.readyState && l.abort(); else {
                            ...
                            f && o(s, c, f, u)
                        }, n.async && 4 !== l.readyState ? (a = ++ft, ut && (ct || (ct = {}, M(e).unload(ut)), ct[a] = r), l.onreadystatechange = r) : r()
                    }, abort: function () {
                        r && r(0, 1)
                    }
                }
        ...
        var dt, pt, ht, mt, gt = {}, vt = /^(?:toggle|show|hide)$/, yt = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
        ...
        M.fn.extend({
            show: function (e, t, n) {
                ...
                for (var o = 0, a = this.length; o < a; o++) (r = this[o]).style && (i = r.style.display, M._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""), "" === i && "none" === M.css(r, "display") && M._data(r, "olddisplay", A(r.nodeName)));
                ...
                for (var r, i, o = 0, a = this.length; o < a; o++) (r = this[o]).style && ("none" === (i = M.css(r, "display")) || M._data(r, "olddisplay") || M._data(r, "olddisplay", i));
                for (o = 0; o < a; o++) this[o].style && (this[o].style.display = "none");
                return this
            }, _toggle: M.fn.toggle, toggle: function (e, t, n) {
                ...
                function i() {
                    ...
                    var t, n, r, i, a, s, l, c, u, f = M.extend({}, o), d = 1 === this.nodeType,
                        p = d && M(this).is(":hidden");
                    f.animatedProperties = {};
                    for (r in e) {
                        if (t = M.camelCase(r), r !== t && (e[t] = e[r], delete e[r]), n = e[t], M.isArray(n) ? (f.animatedProperties[t] = n[1], n = e[t] = n[0]) : f.animatedProperties[t] = f.specialEasing && f.specialEasing[t] || f.easing || "swing", "hide" === n && p || "show" === n && !p) return f.complete.call(this);
                        !d || "height" !== t && "width" !== t || (f.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], "inline" === M.css(this, "display") && "none" === M.css(this, "float") && (M.support.inlineBlockNeedsLayout && "inline" !== A(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                    }
                    null != f.overflow && (this.style.overflow = "hidden");
                    for (r in e) i = new M.fx(this, f, r), n = e[r], vt.test(n) ? (u = M._data(this, "toggle" + r) || ("toggle" === n ? p ? "show" : "hide" : 0)) ? (M._data(this, "toggle" + r, "show" === u ? "hide" : "show"), i[u]()) : i[n]() : (a = yt.exec(n), s = i.cur(), a ? (l = parseFloat(a[2]), "px" !== (c = a[3] || (M.cssNumber[r] ? "" : "px")) && (M.style(this, r, (l || 1) + c), s = (l || 1) / i.cur() * s, M.style(this, r, s + c)), a[1] && (l = ("-=" === a[1] ? -1 : 1) * l + s), i.custom(s, l, c)) : i.custom(s, n, ""));
                    return !0
                }

                var o = M.speed(t, n, r);
                return M.isEmptyObject(e) ? this.each(o.complete, [!1]) : (e = M.extend({}, e), !1 === o.queue ? this.each(i) : this.queue(o.queue, i))
            }, stop: function (e, n, r) {
                return "string" != typeof e && (r = n, n = e, e = t), n && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                    ...
                    if (r || M._unmark(!0, this), null == e) for (n in a) a[n].stop && n.indexOf(".run") === n.length - 4 && t(this, a, n); else a[n = e + ".run"] && a[n].stop && t(this, a, n);
            ...
            speed: function (e, t, n) {
                ...
                return r.duration = M.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in M.fx.speeds ? M.fx.speeds[r.duration] : M.fx.speeds._default, null != r.queue && !0 !== r.queue || (r.queue = "fx"), r.old = r.complete, r.complete = function (e) {
                    M.isFunction(r.old) && r.old.call(this), r.queue ? M.dequeue(this, r.queue) : !1 !== e && M._unmark(this)
                }, r
            }, easing: {
            ...
            update: function () {
                ...
                var o = this, a = M.fx;
                this.startTime = mt || E(), this.end = n, this.now = this.start = e, this.pos = this.state = 0, this.unit = r || this.unit || (M.cssNumber[this.prop] ? "" : "px"), i.queue = this.options.queue, i.elem = this.elem, i.saveState = function () {
                ...
                if (e || i >= s.duration + this.startTime) {
                    ...
                    if (o) {
                        ...
                        }), s.hide && M(a).hide(), s.hide || s.show) for (t in s.animatedProperties) M.style(a, t, s.orig[t]), M.removeData(a, "fxshow" + t, !0), M.removeData(a, "toggle" + t, !0);
                        (r = s.complete) && (s.complete = !1, r.call(a))
                    }
                    return !1
                }
                return s.duration == 1 / 0 ? this.now = i : (n = i - this.startTime, this.state = n / s.duration, this.pos = M.easing[s.animatedProperties[this.prop]](this.state, n, 0, 1, s.duration), this.now = this.start + (this.end - this.start) * this.pos), this.update(), !0
            }
        }, M.extend(M.fx, {
            tick: function () {
                for (var e, t = M.timers, n = 0; n < t.length; n++) (e = t[n])() || t[n] !== e || t.splice(n--, 1);
                t.length || M.fx.stop()
        ...
        "getBoundingClientRect" in O.documentElement ? M.fn.offset = function (e) {
            ...
            if (!t || !M.contains(i, n)) return t ? {top: t.top, left: t.left} : {top: 0, left: 0};
            var o = r.body, a = D(r), s = i.clientTop || o.clientTop || 0, l = i.clientLeft || o.clientLeft || 0,
            ...
            for (var n, r = t.offsetParent, i = t.ownerDocument, o = i.documentElement, a = i.body, s = i.defaultView, l = s ? s.getComputedStyle(t, null) : t.currentStyle, c = t.offsetTop, u = t.offsetLeft; (t = t.parentNode) && t !== a && t !== o && (!M.support.fixedPosition || "fixed" !== l.position);) n = s ? s.getComputedStyle(t, null) : t.currentStyle, c -= t.scrollTop, u -= t.scrollLeft, t === r && (c += t.offsetTop, u += t.offsetLeft, !M.support.doesNotAddBorder || M.support.doesAddBorderForTableAndCells && xt.test(t.nodeName) || (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0), r, r = t.offsetParent), M.support.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0), l = n;
            return "relative" !== l.position && "static" !== l.position || (c += a.offsetTop, u += a.offsetLeft), M.support.fixedPosition && "fixed" === l.position && (c += Math.max(o.scrollTop, a.scrollTop), u += Math.max(o.scrollLeft, a.scrollLeft)), {
                top: c,
                left: u
            }
        }, M.offset = {
            bodyOffset: function (e) {
                ...
                ("absolute" === r || "fixed" === r) && M.inArray("auto", [l, c]) > -1 ? (i = (f = a.position()).top, o = f.left) : (i = parseFloat(l) || 0, o = parseFloat(c) || 0), M.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (u.top = t.top - s.top + i), null != t.left && (u.left = t.left - s.left + o), "using" in t ? t.using.call(e, u) : a.css(u)
            }
        }, M.fn.extend({
            position: function () {
            ...
            M.fn["inner" + n] = function () {
                ...
                if (e === t) {
                    var s = M.css(i, r), l = parseFloat(s);
    ...
    t.asyRequest = function (e) {
        var t = e.i, o = r.generateSaltSign(t);
        i && i.abort(), i = n.ajax({
            type: "POST",
    ...
    var r = function (e) {
        ...
        return {salt: t, sign: n.md5("fanyideskweb" + e + t + "6x(ZHw]mwzX#u0V7@yfwK")}
    };
    ...
    function r(e) {
        ...
        var f = n.join("");
        w.html(f), O.state.originalTgt = w.text(), O.state.smallFont ? w.addClass("input__target__text--small") : w.removeClass("input__target__text--small")
    }
    ...
    function i(e) {
        ...
        n.innerText = e, n.id = t, w.html(""), f(".fanyi-error-message").html(n), setTimeout(function () {
    ...
    function o() {
        var e = f.trim(x.val());
        e = e.replace(/\n/g, "").replace(/\r\n/g, ""), location.href = "http://fanyi.youdao.com/WebpageTranslate?keyfrom=fanyi.web.index&url=" + encodeURIComponent(e) + "&type=" + f("#customSelectVal").val()
    }
    ...
    function a(e) {
        if (0 == f('li[data-value="' + e + '"]').length) f("#langSelect").selectValue("AUTO"); else {
            ...
            O.state.isSelectLan || f(".select-text").text("妫€娴嬪埌锛�" + t)
        }
    }

    function s(e) {
        f(".fanyi-error-message").html(""), e && 0 == e.errorCode ? (O.state = f.extend(O.state, e), a(O.state.type), r(e), e.smartResult && e.translateResult.length > 0 && e.translateResult[0].length > 0 ? (y.clog("RESULT_DICT_SHOW"), v.render(e.translateResult[0][0].src, e.smartResult)) : v.hide(), p.showVoice(O.state.type)) : e && e.errorCode > 0 ? (v.hide(), f("#langSelect").selectValue("AUTO"), i(D.errorMsg[e.errorCode])) : w.html(""), F()
    }
    ...
    function u() {
        f(".show-suggest").removeClass("show-suggest"), N.hide()
    }

    var f = e("./jquery-1.7"), d = e("./utils"), p = e("./voice"), h = null, m = !1, g = e("./service"),
        v = e("./smartResult");
    e("./jquery.selectRange"), e("./md5");
    var y = e("./log"), b = e("./requestMoreTrans"), x = f("#inputOriginal"), w = f("#transTarget"),
        T = f(".fonts__over"), _ = f("#language").val(), C = "AUTO", S = "AUTO", k = "fanyideskweb", E = "", j = "",
        N = f("#fanyiSuggest"), A = navigator.userAgent.indexOf("Trident") > -1, D = e("./constData"),
        O = e("./TranslateState"), L = function (e) {
    ...
    !function () {
        ...
        function r() {
            E && (clearTimeout(E), E = "", f(".fanyi__update__tip").stop(!0, !0)), f(".fanyi__update__tip").hide()
        }
        ...
        w.delegate("span", "mouseover", function () {
            if (!m) {
                var n = f(this), r = n.attr("data-section"), i = n.attr("data-sentence"),
                    o = O.state.translateResult[r][i].src, a = e(r, i),
                    s = (a = Math.max(a, x.val().indexOf(o))) + o.length;
                A || x.selectRange({
                    start: a,
                    end: s
                }), t(n), f("#transTarget span.hover").removeClass("hover"), n.addClass("hover"), y.clog("MATCHING_HOVER&type=" + O.state.type)
            }
        }), w.delegate("span", "click", function () {
            if (!m) {
                var t = f(this), n = t.attr("data-section"), r = t.attr("data-sentence"),
                    i = O.state.translateResult[n][r].src, o = O.state.translateResult[n][r].tgt, a = e(n, r),
                    s = (a = Math.max(a, x.val().indexOf(i))) + i.length;
                A || x.selectRange({start: a, end: s}), y.clog("MUL_RESULT_CLICK&type=" + O.state.type);
                var l = O.state.getDetectedFromTo()[0], u = O.state.getDetectedFromTo()[1];
                c(t, {i: i, tgt: o, from: l, to: u}), g.recordMoreResultLog_get({
                    i: i,
                    from: l,
                    to: u
                }), O.state.updateEle = t
            ...
            var e = O.state.updateEle, t = f(this).text(), r = f(this).attr("systemName"), i = f(this).index();
            O.state.isUpdate = !0, e.text(t), n(), e.addClass("updated");
            var o = O.state.updateEle, a = o.attr("data-section"), s = o.attr("data-sentence"),
                l = O.state.translateResult[a][s].src, c = O.state.translateResult[a][s].tgt,
                u = O.state.getDetectedFromTo()[0], d = O.state.getDetectedFromTo()[1];
            g.recordMoreResultLog_choose({i: l, tgt: c, systemName: r, pos: i, from: u, to: d})
            ...
            m || (f("#transTarget span.hover").removeClass("hover"), A || x.selectRange({start: 0, end: 0}), r())
        }), f(".input__target").on("mousedown", function (e) {
            i(), m = !0, f("#transTarget span.hover").removeClass("hover"), r()
        }), f(".input__target").on("mouseup", function (e) {
            null == d.getSelectionText() && (m = !1), o()
        }), f(".suggest__update__btn").on("click", function () {
            y.clog("RESULT_SINGEL_MODIFY_CLICK"), f("#updateResult").trigger("click", [!0])
        })
    }(), t.translate = function (e, t) {
        _ = f("#language").val();
        var n = x.val(), r = g.generateSaltSign(n), i = n.length;
        if (F(), T.text(i), i > 5e3) {
            var a = n;
            n = a.substr(0, 5e3), r = g.generateSaltSign(n);
            var s = a.substr(5e3);
            s = (s = s.trim()).substr(0, 3), f("#inputTargetError").text("鏈夐亾缈昏瘧瀛楁暟闄愬埗涓�5000瀛楋紝鈥�" + s + "鈥濆強鍏跺悗闈㈡病鏈夎缈昏瘧!").show(), T.addClass("fonts__overed")
        } else T.removeClass("fonts__overed"), f("#inputTargetError").hide();
        d.isWeb(n) ? o() : l({
            i: n,
            from: C,
            to: S,
    ...
    return {
        utf8_decode: function (e) {
            ...
            t.browser.msie ? window.external.addFavorite("http://fanyi.youdao.com/?keyfrom=favorite", "鏈夐亾缈昏瘧 - 鍏嶈垂鍦ㄧ嚎缈昏瘧") : alert("璇蜂娇鐢–trl + D 鎵嬪姩鍔犲叆鏀惰棌")
            ...
            var n = "", r = 0, i = t.property, o = t.original, a = t.value, s = {};
            s[i] = a;
            var l = {};
            l[i] = o, n = setInterval(function () {
    ...
    t.stopVoice = function () {
        ...
        d[e] && g() <= 300 ? (s.removeClass("speaker-disable").show(), s.find(".tips__text--short").text("鏈楄")) : d[e] && g() > 300 ? (s.addClass("speaker-disable").show(), s.find(".tips__text--short").text("鏂囨湰杩囬暱锛屾湕璇诲叧闂�")) : s.hide()
    }, t.init = function () {
    ...
    e("./common/jquery-1.7")(function () {
        e("./common/log").init(), e("./common/account").init(), e("./common/hotLink").init(), e("./common/download").init(), e("./common/voice").init(), e("./common/TranslateState"), e("./operations").init(), e("./common/manTranslate").init(), e("./input"), e("./common/star"), e("./common/copy").init(), e("./common/updateResult").init(), e("./common/docTrans").init()
    })
    ...
    function s(e) {
        ...
        u[0].scrollTop = 0, f[0] ? (t.addClass("input__small__font"), t.css({
            ...
            r()
        }), y.reset(), b.hideDocTrans()) : (a(), m.showVoice("AUTO"), l("#transTarget").html(""), l("#transTarget").css("height", "auto"), u.css("height", "auto"), g.hide(), l("#langSelect").selectValue("AUTO"), l(".fanyi-error-message").html(""), l("#docUploadBg").is(":visible") || b.showDocTrans()), i()
    }
    ...
    t.init = function () {
        n("#langSelect").select({
            changedCallback: function () {
                ...
                "ar" == e.split("2", 1) ? (n(".input__original .fanyi__input__bg").addClass("fanyi__input__bg__ar"), n(".input__original_delete").addClass("input__original_delete_ar")) : (n(".input__original .fanyi__input__bg").removeClass("fanyi__input__bg__ar"), n(".input__original_delete").removeClass("input__original_delete_ar")), n("#language").val(e), "AUTO" == e ? r.state.isSelectLan = !1 : (r.state.isSelectLan = !0, n("#langSelect").removeClass("empty-lang")), r.state.type = e, "" != n("#inputOriginal").val() && n("#transMachine").trigger("click", [!0, "lan-select"]), i.reset(), o.clog("LAN_SWITCH_CLICK", "")
            }
        })
        ...
        e ? "zh-CHS2en" != r && "en2zh-CHS" != r && (n("#langSelect .default a").text("璇烽€夋嫨璇█"), n("#langSelect").addClass("empty-lang"), n("#langSelect").selectValue("AUTO")) : (n("#langSelect .default a").text("鑷姩妫€娴嬭瑷€"), n("#langSelect").removeClass("empty-lang"), n("#langSelect").selectValue("AUTO"))
    ...
    function i() {
        l(".user-name").hover(function () {
            d && (clearTimeout(d), d = ""), l(".account-cover").show()
        }, function () {
    ...
    var l = e("./common/jquery-1.7"), c = e("./langSelect"), u = e("./common/utils"), f = e("./common/log"), d = "";
    t.init = function () {
        var e = "";
        a(), c.init(), n(), r(), i(), o(), s(), l(window).on("resize", function () {
